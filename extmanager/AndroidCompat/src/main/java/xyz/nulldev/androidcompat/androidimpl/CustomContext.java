...
public class CustomContext extends Context {
    ...
    public File getExternalFilesDir(String s) {
        return androidFiles.getExternalFilesDirs();
    }

    @Override
    public File[] getExternalFilesDirs(String s) {
        File[] arr = new File[1];
        arr[0] = androidFiles.getExternalFilesDirs();
        return arr;
    }

    @Override
    public File getObbDir() {
        return androidFiles.getObbDirs();
    }

    @Override
    public File[] getObbDirs() {
        File[] arr = new File[1];
        arr[0] = androidFiles.getObbDirs();
        return arr;
    }
    ...
    public File getExternalCacheDir() {
        return androidFiles.getExternalCacheDirs();
    }

    @Override
    public File[] getExternalCacheDirs() {
        File[] arr = new File[1];
        arr[0] = androidFiles.getExternalCacheDirs();
        return arr;
    }
    ...
    public File[] getExternalMediaDirs() {
        File[] arr = new File[1];
        arr[0] = androidFiles.getExternalMediaDirs();
        return arr;
    }
